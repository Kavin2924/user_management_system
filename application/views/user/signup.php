...
<?php echo link_tag('assests/css/sb-admin.css'); ?>
  ...
  <body class="bg-dark">
      ...
      <nav class="navbar navbar-expand navbar-dark bg-secondary static-top">
        ...
        <a class="mt-3" href="<?php echo site_url('user/Login'); ?>">Login Page</a>&nbsp&nbsp&nbsp    
        <a class="mt-3" >User Registration</a>&nbsp&nbsp&nbsp
      </nav>
      <!--end nav-->
    

    <div class="container"><!--start container-->
      <div class="card card-register mx-auto mt-5"><!--start card card-register-->
